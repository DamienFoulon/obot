...
# The embed pages carry an anonymous access token: never commit it (secret scanners flag it)
sed -i -E 's/"accessToken":"[^"]*"/"accessToken":"REDACTED"/g; s/"clientId":"[^"]*"/"clientId":"REDACTED"/g' $F/spotify-*.html
